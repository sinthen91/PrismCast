...
1. Create an empty public GitHub repository named `PrismCast` under the `sinthen91` account.
...
6. Friends can then add this custom repository URL to Dalamud:
   ...
   `https://raw.githubusercontent.com/sinthen91/PrismCast/main/pluginmaster.json`
